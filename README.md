...
Now you see the yaml pipeline which is auto generated by Azure but i have done some changes like adding the agent vm name, and i have used two stages one for build and another for push. you can use this yaml also. but ensure you add your own self host agent.

<img width="591" height="831" alt="image" src="https://github.com/user-attachments/assets/0aec79ef-eba3-4df2-9d28-db090a1350cc" />
